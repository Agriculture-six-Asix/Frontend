            ...
            <div className="w-fit h-fit bg-[#F8F9FA] rounded-md overflow-hidden shadow-xl fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                ...
                <div className="py-8 px-8">
                    ...
                    <div className="flex justify-end gap-x-4 mt-8">
                        <button
                            type="button"
                            className={`transition-colors py-2 px-8 rounded-md font-semibold hover:bg-deleteHoverColor text-white ${props.isLoading ? "bg-deleteHoverColor" : "bg-deleteColor"}`}
